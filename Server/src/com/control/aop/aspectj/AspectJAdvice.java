...
package com.control.aop.aspectj;
...
public class AspectJAdvice {
     ...
     */
    @Pointcut("execution(* com.control.aop.aspectj.*.*(..))")
    public void anyMethod() {
        System.out.println("开始切点 \n");
    }
     ...
     * @param jp
     */
    @Before(value = "execution(* com.control.aop.aspectj.*.*(..))")
    public void doBefore(JoinPoint jp) {
        System.out.println("=======jjjj====进入before advice============ \n");
    ...
    public void doAfter(JoinPoint jp, String result) {
        System.out.println("======jjjj====进入after advice=========== \n");
     ...
     * @param pjp 连接点
     */
    @Around(value = "execution(* com.control.aop.aspectj.*.*(..))")
    public void doAround(ProceedingJoinPoint pjp) throws Throwable {
        System.out.println("=====jjjj======进入around环绕方法！=========== \n");
     ...
     * @param e
     */
    @AfterThrowing(value = "execution(* com.control.aop.aspectj.*.*(..))", throwing = "e")
